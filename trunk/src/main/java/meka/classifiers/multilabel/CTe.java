...
/**
 * CTe - Classifier Trellis. Run a CC in a trellis structure.
 * @author	Jesse Read
 * @version April 2014
 */
public class CTe extends MCCe {

	protected int m_Width = -1;
	protected int m_Connectivity = 1;

	// @TODO: use MCCe's P instead
	...
	public void buildClassifier(Instances D) throws Exception {
		...
		// So we can use the MCCe.java and CCe.java framework
	...
	public static void main(String args[]) {
		MultilabelClassifier.evaluation(new CTe(),args);
	}
}
