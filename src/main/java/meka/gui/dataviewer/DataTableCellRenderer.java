...
public class DataTableCellRenderer
	 ...
	 */
	public DataTableCellRenderer(Color missingColor,
	...
	public Component getTableCellRendererComponent(
		...
		if (table instanceof DataTable)
			searchString = ((DataTable) table).getSearchString();
		else
			searchString = null;
		...
		if (table.getModel() instanceof DataSortedTableModel) {
