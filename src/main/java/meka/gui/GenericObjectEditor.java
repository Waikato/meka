...
extends weka.gui.GenericObjectEditor {
  ...
  public static final String MEKA_GUIEDITORS_PROPERTY_FILE = "meka/gui/GUIEditors.props";

  /** The name of the properties file to use as a template. */
  protected static String CREATOR_FILE = "meka/gui/GenericPropertiesCreator.props";
