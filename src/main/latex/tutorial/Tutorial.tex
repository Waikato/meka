...
Since Version 1.2 \framework{\MEKA} has a graphical user interface (GUI). Run this with either the \texttt{run.sh} (under Linux, OSX) or \texttt{run.bat} (under Microsoft windows) scripts, e.g.: \marginpar{true?} 
\begin{verbatim}
	./run.sh
\end{verbatim}
...
{\small \marginpar{{\blue to update!}}
\begin{verbatim}
